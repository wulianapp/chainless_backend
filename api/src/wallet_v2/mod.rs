...
/**
* @api {get} /wallet_v2/getStrategy 查询钱包的主从签名策略
* @apiVersion 0.0.2
* @apiName getStrategy
* @apiGroup Wallet
* @apiHeader {String} Authorization  user's access token
* @apiExample {curl} Example usage:
*   curl -X POST http://120.232.251.101:8066/wallet_v2/getStrategy
* -H "Content-Type: application/json" -H 'Authorization:Bearer eyJ0eXAiOiJKV1QiLCJhbGci
   OiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxLCJkZXZpY2VfaWQiOiIyIiwiaWF0IjoxNzA2ODQ1ODgwODI3LCJleHA
   iOjE3MDgxNDE4ODA4Mjd9.YsI4I9xKj_y-91Cbg6KtrszmRxSAZJIWM7fPK7fFlq8'
...
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/getStrategy
*/
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[get("/wallet_v2/getStrategy")]
async fn get_strategy(req: HttpRequest) -> impl Responder {
    gen_extra_respond(get_lang(&req), handlers::get_strategy::req(req).await)
}

/**
* @api {get} /wallet_v2/estimateTransferFee 预估手续费
* @apiVersion 0.0.2
...
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/estimateTransferFee
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[get("/wallet_v2/estimateTransferFee")]
...
/**
* @api {get} /wallet_v2/getFeesPriority 获取抵扣手续费的币种顺序
* @apiVersion 0.0.2
...
/**
 * @api {post} /wallet_v2/preSendMoneyToSub 主钱包发起给子账户的预交易
 * @apiVersion 0.0.2
...
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/preSendMoneyToSub
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/preSendMoneyToSub")]
...
/**
 * @api {post} /wallet_v2/subSendToMain 子账户给主账户打款
 * @apiVersion 0.0.2
...
/**
 * @api {post} /wallet_v2/addServant 主设备添加从公钥
 * @apiVersion 0.0.2
 * @apiName addServant
 * @apiGroup Wallet
...
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/addServant
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/addServant")]
...
/**
 * @api {post} /wallet_v2/newcommerSwitchServant 在主设备上选择新设备替换从设备
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/newcommerSwitchServant
   -d ' {"“}'
   -H "Content-Type: application/json" -H 'Authorization:Bearer eyJ0eXAiOiJKV1QiLCJhbGci
    OiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxLCJkZXZpY2VfaWQiOiIyIiwiaWF0IjoxNzA2ODQ1ODgwODI3LCJleHA
    iOjE3MDgxNDE4ODA4Mjd9.YsI4I9xKj_y-91Cbg6KtrszmRxSAZJIWM7fPK7fFlq8'
...
* @apiSuccess {String=HaveUncompleteTx} msg
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/newcommerSwitchServant
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/newcommerSwitchServant")]
...
/**
 * @api {post} /wallet_v2/removeServant 在主设备上删除从设备
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/removeServant
   -d ' {"“}'
   -H "Content-Type: application/json" -H 'Authorization:Bearer eyJ0eXAiOiJKV1QiLCJhbGci
    OiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxLCJkZXZpY2VfaWQiOiIyIiwiaWF0IjoxNzA2ODQ1ODgwODI3LCJleHA
    iOjE3MDgxNDE4ODA4Mjd9.YsI4I9xKj_y-91Cbg6KtrszmRxSAZJIWM7fPK7fFlq8'
...
* @apiSuccess {String=HaveUncompleteTx} msg
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/removeServant
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/removeServant")]
...
/**
 * @api {post} /wallet_v2/addSubaccount 添加子钱包
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/addSubaccount
   -d ' {
             "deviceId": "1",
...
/**
 * @api {post} /wallet_v2/removeSubaccount 删除子钱包
 * @apiVersion 0.0.2
...
* @apiSuccess {String=HaveUncompleteTx} msg
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/removeSubaccount
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/removeSubaccount")]
...
/**
 * @api {post} /wallet_v2/updateStrategy 更新主钱包多签梯度
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/updateStrategy
   -d '  {
...
* @apiSuccess {String=HaveUncompleteTx} msg
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/updateStrategy
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/updateStrategy")]
...
/**
 * @api {post} /wallet_v2/setFeesPriority 设置手续费币种扣减顺序
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/setFeesPriority
   -d '  {
             "strategy": [{"min": 0, "maxEq": 100, "sigNum": 0},{"min": 100, "maxEq": 1844674407370955200, "sigNum": 1}]
            }'
   -H "Content-Type: application/json" -H 'Authorization:Bearer eyJ0eXAiOiJKV1QiLCJhbGci
...
* @apiSuccess {String=HaveUncompleteTx} msg
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/setFeesPriority
*/
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/setFeesPriority")]
...
/**
 * @api {post} /wallet_v2/updateSubaccountHoldLimit 更新子钱包的持仓额度
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/updateSubaccountHoldLimit
   -d '  {
            }'
   -H "Content-Type: application/json" -H 'Authorization:Bearer eyJ0eXAiOiJKV1QiLCJhbGci
    OiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxLCJkZXZpY2VfaWQiOiIyIiwiaWF0IjoxNzA2ODQ1ODgwODI3LCJleHA
...
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/updateSubaccountHoldLimit
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/updateSubaccountHoldLimit")]
...
/**
 * @api {post} /wallet_v2/updateSecurity 更新安全密码
 * @apiVersion 0.0.2
...
/**
 * @api {post} /wallet_v2/createMainAccount 创建主钱包
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/createMainAccount
   -d '  {
             "encryptedPrikey": "",
             "pubkey": "",
            }'
...
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/createMainAccount
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/createMainAccount")]
...
/**
 * @api {post} /wallet_v2/faucetClaim 领取测试币
 * @apiVersion 0.0.2
 * @apiName faucetClaim
 * @apibody {String} accountId
 * @apiGroup Wallet
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/putPendingPubkey
   -d '  {
...
* @apiSuccess {String} msg 状态信息
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/faucetClaim
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/faucetClaim")]
...
/**
 * @api {get} /wallet_v2/balanceList 返回支持的资产的余额信息
 * @apiVersion 0.0.2
 * @apiName balanceList
 * @apiGroup Wallet
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/balanceList?kind=Main
   -H "Content-Type: application/json" -H 'Authorization:Bearer eyJ0eXAiOiJKV1QiLCJhbGci
    OiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxLCJkZXZpY2VfaWQiOiIyIiwiaWF0IjoxNzA2ODQ1ODgwODI3LCJleHA
    iOjE3MDgxNDE4ODA4Mjd9.YsI4I9xKj_y-91Cbg6KtrszmRxSAZJIWM7fPK7fFlq8'
* @apiSuccess {String=0,1} status_code         状态码.
...
/**
 * @api {get} /wallet_v2/singleBalance 获取单账户单币种的余额
 * @apiVersion 0.0.2
...
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/getBalance
*/
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[get("/wallet_v2/singleBalance")]
...
/**
 * @api {post} /wallet_v2/genNewcomerSwitchMaster 构建在新设备上和主设备身份互换的任务
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/genNewcomerSwitchMaster
   -d '  {
             "encryptedPrikey": "",
             "pubkey": "",
            }'
...
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/genNewcomerSwitchMaster
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/genNewcomerSwitchMaster")]
...
/**
 * @api {post} /wallet_v2/genServantSwitchMaster 构建在从设备上和主设备身份互换的任务
 * @apiVersion 0.0.2
...
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/genServantSwitchMaster
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/genServantSwitchMaster")]
...
/**
 * @api {post} /wallet_v2/genSendMoney 构建send_money的交易数据
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/GenSendMoney
   -d '  {
             "encryptedPrikey": "",
             "pubkey": "",
            }'
...
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/genSendMoney
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/genSendMoney")]
...
/**
 * @api {post} /wallet_v2/commitNewcomerSwitchMaster 提交在新设备上和主设备身份互换的任务
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/commitNewcomerSwitchMaster
   -d '  {
             "encryptedPrikey": "",
             "pubkey": "",
            }'
...
* @apiSuccess {String=HaveUncompleteTx} msg
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/commitNewcomerSwitchMaster
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/commitNewcomerSwitchMaster")]
...
/**
 * @api {post} /wallet_v2/commitServantSwitchMaster 提交在从设备上和主设备身份互换的任务
 * @apiVersion 0.0.2
 ...
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *   curl -X POST http://120.232.251.101:8066/wallet_v2/commitServantSwitchMaster
   -d '  {
             "encryptedPrikey": "",
             "pubkey": "",
            }'
...
* @apiSuccess {String=HaveUncompleteTx} msg
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/wallet_v2/commitServantSwitchMaster
*/
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/wallet_v2/commitServantSwitchMaster")]
