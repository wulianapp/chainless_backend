...
/**
 * @api {post} /bridge_v2/preWithdraw 主钱包发起提现跨链的预交易
 * @apiVersion 0.0.2
 * @apiName PreWithdraw
 * @apiGroup Bridge
...
/**
 * @api {post} /bridge_v2/bindEthAddr 在chainless绑定eth地址
 * @apiVersion 0.0.2
 * @apiName BindEthAddr
 * @apiGroup Bridge
...
/**
 * @api {post} /bridge_v2/genBindEthAddrSig  生成ETH地址绑定信息签名
 * @apiVersion 0.0.2
...
/**
 * @api {get} /bridge_v2/getBindedEthAddr 获取用户绑定的eth地址
 * @apiVersion 0.0.2
