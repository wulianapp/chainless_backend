...
use models::{account_manager::{UserFilter, UserInfoView}, device_info::{DeviceInfoFilter, DeviceInfoView}, secret_store::{SecretFilter, SecretStoreView}, PsqlOp};
...
pub(crate) async fn req(
    ...
    match request_data.r#type {
        ...
        crate::wallet::SecretType::All => {
            ...
            let mut strategy = cli.get_strategy(&main_account).await?.ok_or(BackendError::InternalError("".to_string()))?;
