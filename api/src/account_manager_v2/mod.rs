...
/**
 * @api {post} /accountManager_v2/getCaptchaWithoutToken 未登陆时申请验证码,
 * @apiVersion 0.0.2
 ...
 *   curl -X POST http://120.232.251.101:8066/accountManager_v2/getCaptchaWithoutToken -H "Content-Type: application/json" -d
 ...
 * @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/getCaptchaWithoutToken
 */
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/getCaptchaWithoutToken")]
...
/**
 * @api {post} /accountManager_v2/getCaptchaWithToken 登陆后申请验证码
 * @apiVersion 0.0.2
...
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/getCaptchaWithToken")]
...
/**
 * @api {get} /accountManager_v2/contactIsUsed 检查账户是否已被使用
 * @apiVersion 0.0.2
 * @apiName contactIsUsed
 * @apiGroup AccountManager
 * @apiQuery {String} contact   邮箱或者手机号
 * @apiExample {curl} Example usage:
 * curl -X GET "http://120.232.251.101:8066/accountManager_v2/contactIsUsed?contact=test000001@gmail.com"
 ...
 * @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/contactIsUsed
 */

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[get("/accountManager_v2/contactIsUsed")]
...
*/
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[get("/accountManager_v2/checkCaptcha")]
...
/**
 * @api {get} /accountManager_v2/userInfo 用户账号详情
 * @apiVersion 0.0.2
 * @apiName userInfo
 * @apiGroup AccountManager
 ...
 * @apiExample {curl} Example usage:
 * curl -X GET "http://120.232.251.101:8066/accountManager_v2/userInfo"
 * @apiSuccess {String=0,1,} status_code         状态码.
 * @apiSuccess {String} msg 状态信息
 ...
 * @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/userInfo
 */

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[get("/accountManager_v2/userInfo")]
...
* @apiExample {curl} Example usage:
    curl -X POST http://120.232.251.101:8066/accountManager_v2/registerByEmail -H "Content-Type: application/json" -d
...
* @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/registerByEmail
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/registerByEmail")]
...
* @apiBody {String} [predecessorInviteCode]   推荐人的邀请码
* @apiExample {curl} Example usage:
*    curl -X POST http://120.232.251.101:8066/accountManager_v2/registerByPhone -H "Content-Type: application/json" -d
...
*/
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/registerByPhone")]
...
/**
 * @api {post} /accountManager_v2/login 通过密码登录
 * @apiVersion 0.0.2
 * @apiName login
 * @apiGroup AccountManager
 * @apiBody {String} deviceId   设备ID
 ...
 * @apiExample {curl} Example usage:
 *    curl -X POST http://120.232.251.101:8066/accountManager_v2/login -H "Content-Type: application/json" -d
 *  '{"deviceId": "1234","contact": "test000001@gmail.com","password":"123456789"}'
* @apiSuccess {String=0,1,2008,2009,2012} status_code         状态码.
* @apiSuccess {String} msg                  状态详情
 * @apiSuccess {String} data                token值.
 * @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/login
 */
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/login")]
...
/**
 * @api {get} /accountManager_v2/getUserDeviceRole 获取当前用户当前设备的角色信息
 * @apiVersion 0.0.2
 ...
 * @apiExample {curl} Example usage:
 *    curl -X POST http://120.232.251.101:8066/accountManager_v2/getUserDeviceRole -H "Content-Type: application/json" -d
 *  '{"deviceId": "1234","contact": "test000001@gmail.com","password":"123456789"}'
* @apiSuccess {String=0,1,2008} status_code         状态码.
* @apiSuccess {String} msg  状态详情
 * @apiSuccess {String=Master,Servant,Undefined} data               角色信息.
 * @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/getUserDeviceRole
 */

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[get("/accountManager_v2/getUserDeviceRole")]
...
/**
 * @api {post} /accountManager_v2/loginByCaptcha   通过验证码登录
 * @apiVersion 0.0.2
 ...
 */
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/loginByCaptcha")]
...
* @apiExample {curl} Example usage:
  curl -X POST http://120.232.251.101:8066/accountManager_v2/resetPassword -H "Content-Type: application/json"
...
* @apiSuccess {String} msg                 状态详情
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/resetPassword
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/resetPassword")]
...
* @apiHeader {String} Authorization  user's access token
* @apiExample {curl} Example usage:
  curl -X POST http://120.232.251.101:8066/accountManager_v2/ -H "Content-Type: application/json"
 -d '{"deviceId": "123","contact": "test000001@gmail.com","captcha":"287695","newPassword":"123456788"}'
* @apiSuccess {String=0,1,2002,2003,2004,2008,3008} status_code         状态码.
* @apiSuccess {String} msg                 状态详情
* @apiSuccess {String} data                null
* @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/replenishContact
*/

#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/replenishContact")]
...
/**
 * @api {post} /accountManager_v2/genToken   生成新的token
 * @apiVersion 0.0.2
 * @apiName GenToken
 * @apiGroup AccountManager
 * @apiHeader {String} Authorization  user's access token
 * @apiExample {curl} Example usage:
 *    curl -X POST http://120.232.251.101:8066/accountManager_v2/ssssss -H "Content-Type: application/json" -d
 *  '{"deviceId": "1234","contact": "test000001@gmail.com","password":"123456789"}'
* @apiSuccess {String=0,1,2002,2003,2004,2008} status_code         状态码.
* @apiSuccess {String} msg  状态详情
 * @apiSuccess {String} data                token值.
 * @apiSampleRequest http://120.232.251.101:8066/accountManager_v2/genToken
 */
#[tracing::instrument(skip_all,fields(trace_id = get_trace_id(&req)))]
#[post("/accountManager_v2/genToken")]
